...
void MovingCubeMain::SetHolographicSpace(HolographicSpace^ holographicSpace)
{
	...
	m_locatabilityChangedToken =
		...
		ref new Windows::Foundation::TypedEventHandler<SpatialLocator^, Object^>(
			std::bind(&MovingCubeMain::OnLocatabilityChanged, this, _1, _2)
			);
	...
	m_cameraAddedToken =
		...
		ref new Windows::Foundation::TypedEventHandler<HolographicSpace^, HolographicSpaceCameraAddedEventArgs^>(
			std::bind(&MovingCubeMain::OnCameraAdded, this, _1, _2)
			);
	...
	m_cameraRemovedToken =
		...
		ref new Windows::Foundation::TypedEventHandler<HolographicSpace^, HolographicSpaceCameraRemovedEventArgs^>(
			std::bind(&MovingCubeMain::OnCameraRemoved, this, _1, _2)
			);
...
void MovingCubeMain::UnregisterHolographicEventHandlers()
{
...
HolographicFrame^ MovingCubeMain::Update()
{
...
bool MovingCubeMain::Render(Windows::Graphics::Holographic::HolographicFrame^ holographicFrame)
{
...
void MovingCubeMain::SaveAppState()
{
	//
...
void MovingCubeMain::LoadAppState()
{
	//
...
void MovingCubeMain::OnDeviceLost()
{
#ifdef DRAW_SAMPLE_CONTENT
	for (auto& i : m_objRenderers) {
		i->ReleaseDeviceDependentResources();
	}
#endif
}
...
void MovingCubeMain::OnDeviceRestored()
{
#ifdef DRAW_SAMPLE_CONTENT
	for (auto& i : m_objRenderers) {
		i->CreateDeviceDependentResources();
	}
#endif
}

void MovingCubeMain::OnLocatabilityChanged(SpatialLocator^ sender, Object^ args)
{
...
void MovingCubeMain::OnCameraAdded(
...
void MovingCubeMain::OnCameraRemoved(
	HolographicSpace^ sender,
